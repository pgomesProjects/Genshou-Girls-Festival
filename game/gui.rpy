...
define gui.hover_color = '#8A6CBE'

## The color used for a text button when it is selected but not focused. A
## button is selected if it is the current screen or preference value.
define gui.selected_color = '#7C67A0'

## The color used for a text button when it cannot be selected.
define gui.insensitive_color = '#412276'
...
define gui.interface_text_font = "fonts/AcademyEngraved.ttf"
...
define gui.choice_button_text_hover_color = "#dddddd"
